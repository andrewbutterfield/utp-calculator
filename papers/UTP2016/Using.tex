...
window to highlight old and new parts of predicates as chages are made.
Currently this only works well on the Mac OS X terminal,
because it seems to be the only one that properly supports ANSI secpae sequences.
