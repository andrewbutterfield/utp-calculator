...
\begin{itemize}
  ...
  \item
    ...
    and apply that.
\end{itemize}
The last requirement above was an initial gamble,
to keep things simple.
However, most calculations turn out to be exhaustive,
in the sense that every applicable rule gets applied,
and the order of application of most of these rules has no effect
on the final outcome.
The effect of this was that this simplistic approach was retained
as there was never any case when it prevented us completing a calculation.
