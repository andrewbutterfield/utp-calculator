...
in the Unifying Theories of Programming paradigm,
by supporting an easy way to very quickly perform test calculations.
...
of the calculator and how various aspects of such a theory
might be encoded.
We finish with a discussion of our experience in using the tool.
The final publication is available at Springer via \url{TBD} .
\end{abstract}
